...
$statement = $db->prepare('SELECT item_id, item, item_type, cost, cost_type, remark, to_date(date, "DD-MM-YYYY"), i.user_name FROM items i LEFT JOIN users u ON i.user_name=u.user_name WHERE u.user_name=:username');
