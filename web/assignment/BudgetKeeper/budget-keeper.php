...
?>
  <div class="div-info">
    ...
    foreach ($items as $item)
    {
      ...
      echo "<tr><td>" . $item['item'] . "</td><td>" . $item['item_type'] . "</td><td>" . $item['cost'] . "</td><td>" . $item['cost_type'] . "</td><td>". $item['remark'] . "</td><td><a href='item-update.php?id=$item_id&i=$item'>Edit</a></td><td><a href='deleteDB.php?item_id=$item_id'>Delete</a></td></tr>";
    }
    ?>
    </table>
  </div>
