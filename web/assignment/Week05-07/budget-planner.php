...
?>
  <div class="div-info">
    ...
    {
      echo "<tr><td>" . $item['item_id'] . '</td><td>' . $item['item'] . '</td><td>' . $item['item_type'] . '</td><td>' . $item['cost'] . '</td><td>' . $item['cost_type'] . '</td><td>'. $item['remark'] . '</td><td><button type="button">Edit</button></td><td><button type="button">Delete</button></td></tr>';
    }
    ?>
    </table>
  </div>
